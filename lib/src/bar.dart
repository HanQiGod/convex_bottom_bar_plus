...
enum TabStyle {
  ...
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-fixed.gif)
  fixed,

  /// Convex shape is fixed center with circle, see [FixedCircleTabStyle].
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-fixed-circle.gif)
  fixedCircle,

  /// Convex shape is moved after selection, see [ReactTabStyle].
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-react.gif)
  react,

  /// Convex shape is moved with circle after selection, see [ReactCircleTabStyle].
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-react-circle.gif)
  reactCircle,

  /// Tab icon, text animated with pop transition.
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-textIn.gif)
  textIn,

  /// Similar to [TabStyle.textIn], text first.
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-titled.gif)
  titled,

  /// Tab item is flipped when selected, does not support [flutter web].
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-flip.gif)
  flip,
...
/// Online example can be found at http://hacktons.cn/convex_bottom_bar_plus.
///
/// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-theming.png)
class ConvexAppBar extends StatefulWidget {
  ...
  ///
  /// ![corner image](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-corner.png)
  final double? cornerRadius;

  /// If provided, backgroundColor for tab app will be ignored.
  ///
  /// ![](https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/appbar-gradient.gif)
  ...
  ///
  /// {@animation 1010 598 https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/badge-demo.mp4}
  ///
...
class ConvexAppBarState extends State<ConvexAppBar>
  ...
  void _resetState() {
    ...
    if (!isFixed() && _controller != null) {
      ...
      // https://github.com/hacktons/convex_bottom_bar_plus/issues/67
      _updateAnimation();
    }
  }
