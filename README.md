<p align="center"><img src="https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/preview.png" alt="appBar preview"></p>
<p align="center">
  <a href="https://pub.dev/packages/convex_bottom_bar_plus"><img src="https://img.shields.io/pub/v/convex_bottom_bar_plus.svg" alt="pub.dev"></a>
  <a href="https://github.com/hacktons/convex_bottom_bar_plus"><img src="https://img.shields.io/badge/platform-flutter-ff69b4.svg" alt="github"></a>
  <a href="https://coveralls.io/github/hacktons/convex_bottom_bar_plus"><img src="https://coveralls.io/repos/github/hacktons/convex_bottom_bar_plus/badge.svg" alt="coverage status"></a>
  <a href="https://pub.dev/packages/convex_bottom_bar_plus/score"><img src="https://badges.bar/convex_bottom_bar_plus/likes" alt="likes"></a>
  ...
  <a href="https://github.com/hacktons/convex_bottom_bar_plus/raw/LICENSE"><img src="https://img.shields.io/github/license/hacktons/convex_bottom_bar_plus.svg" alt="license"></a>
</p>
<p align="center">
    <a href="https://github.com/hacktons/convex_bottom_bar_plus/blob/master/README.md">English</a>
    | <a href="https://github.com/hacktons/convex_bottom_bar_plus/blob/master/README-zh.md">简体中文</a>
</p>
...
**convex_bottom_bar_plus is now a [Flutter Favorite](https://flutter.dev/docs/development/packages-and-plugins/favorites) package!**

<a href="https://flutter.dev/docs/development/packages-and-plugins/favorites">
<img height="128" src="https://github.com/hacktons/convex_bottom_bar_plus/raw/master/doc/flutter-favorite.png">
</a>
...
Add this to your package's pubspec.yaml file, use the latest version [![Pub](https://img.shields.io/pub/v/convex_bottom_bar_plus.svg)](https://pub.dartlang.org/packages/convex_bottom_bar_plus):

```yaml
dependencies:
  convex_bottom_bar_plus: ^latest_version
```

```dart
import 'package:convex_bottom_bar_plus/convex_bottom_bar_plus.dart';
...
## FAQ
Please file feature requests and bugs at the [issue tracker](https://github.com/hacktons/convex_bottom_bar_plus/issues).
